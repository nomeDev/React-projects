...
export default function Banner() {
    return (
        <div className="w-full h-fit py-6 md:h-[calc(100vh-93px)] overflow-hidden bg-gradient-to-r from-purple-700 to-indigo-800">
            <div className="container w-full h-full max-w-[1400px] mx-auto flex flex-col-reverse md:flex-row gap-12 items-center justify-center overflow-hidden">
                <div className="content w-[100%] md:w-[35%] text-center text-white">
                    <h1 className="lg:text-[130px] md:text-[100px] text-[75px] sm:text-[110px] leading-[100%] font-[600] mb-6">
                        SALES
                    </h1>
